...
var player_lap = 0;			// annan sak Ã¤n lap!
...
const mesh_logo_ep = new THREE.Mesh(new THREE.PlaneGeometry(2.4, 0.75), new THREE.MeshBasicMaterial({map: loader.load("files/coollogo_com-65002507.png"), transparent: true, side: THREE.DoubleSide, alphaTest: 0.5}));
...
// music sequencer
var audiocontext_bass = new AudioContext();
var request_bass = xhtmlsound("../f/files/applebass.mp3");
var gainnode_bass = audiocontext_bass.createGain();
var source_bass;
request_bass.onload = load_audio;
function load_audio()
{
	audiocontext_bass.decodeAudioData(request_bass.response, function load_audio2(buffer)
	{
		source_bass = audiocontext_bass.createBufferSource();
		source_bass.buffer = buffer;
	});
}

var audiocontext_lead = new AudioContext();
//var request_lead = xhtmlsound("../f/files/roomyC.mp3");
var request_lead = xhtmlsound("../f/files/scarylead.mp3");
var gainnode_lead = audiocontext_lead.createGain();
var source_lead;
request_lead.onload = load_audio_lead;
function load_audio_lead()
{
	audiocontext_lead.decodeAudioData(request_lead.response, function load_audio2(buffer)
	{
		source_lead = audiocontext_lead.createBufferSource();
		source_lead.buffer = buffer;
	});
}

var audiocontext_padd  = new AudioContext();
//var request_padd = xhtmlsound("../f/files/trance_lead.mp3");
var request_padd = xhtmlsound("../f/files/trance_lead.mp3");
var gainnode_padd = audiocontext_padd.createGain();
var source_padd;
request_padd.onload = load_audio_padd;
function load_audio_padd()
{
	audiocontext_padd.decodeAudioData(request_padd.response, function load_audio2(buffer)
	{
		source_padd = audiocontext_padd.createBufferSource();
		source_padd.buffer = buffer;
	});
}

var audiocontext_kick = new AudioContext();
//var request_kick = xhtmlsound("../f/files/kick.mp3");
var request_kick = xhtmlsound("../f/files/rockkick.mp3");
var gainnode_kick = audiocontext_kick.createGain();
var source_kick;
request_kick.onload = load_audio_kick;
function load_audio_kick()
{
	audiocontext_kick.decodeAudioData(request_kick.response, function load_audio2(buffer)
	{
		source_kick = audiocontext_kick.createBufferSource();
		source_kick.buffer = buffer;
	});
}

var audiocontext_snar = new AudioContext();
//var request_snar = xhtmlsound("../f/files/snare.mp3");
var request_snar = xhtmlsound("../f/files/rocksnare.mp3");
var gainnode_snar = audiocontext_snar.createGain();
var source_snar;
request_snar.onload = load_audio_snar;
function load_audio_snar()
{
	audiocontext_snar.decodeAudioData(request_snar.response, function load_audio2(buffer)
	{
		source_snar = audiocontext_snar.createBufferSource();
		source_snar.buffer = buffer;
	});
}

var audiocontext_hiha = new AudioContext();
//var request_hiha = xhtmlsound("../f/files/hihat.mp3");
var request_hiha = xhtmlsound("../f/files/rockride.mp3");
var gainnode_hiha = audiocontext_hiha.createGain();
var source_hiha;
request_hiha.onload = load_audio_hiha;
function load_audio_hiha()
{
	audiocontext_hiha.decodeAudioData(request_hiha.response, function load_audio2(buffer)
	{
		source_hiha = audiocontext_hiha.createBufferSource();
		source_hiha.buffer = buffer;
	});
}

var lead = new Array();

var bass = "A a A a F f F f C c C c G g H h ";
lead[0]  = "c c B B F   A A G G D D F E D E ";
lead[1]  = "c c d d A   d t e g c G d G c B ";
var kick = "K       K K     K       K K     ";
var snar = "    S       S       S       S   ";
var padd = "                                ";
var hiha = "HhHhHhHhHhHhHhHhHhHhHhHhHhHhHhHh";

//var bass = "C C   C C   C   F F   F V   G   ";
//lead[0]  = "G c g G G c g c f c c f v v g   ";
//lead[1]  = "C   D E     C E F   E D     G   ";
//var padd = "c g c g c g c g f c f c v f g d ";
//var kick = "K       K K     K       K K     ";
//var snar = "    S       S       S       S   ";
//var hiha = "HhHhHhHhHhHhHhHhHhHhHhHhHhHhHhHh";

//var bass = "D D D D D D D D D D D D D D D D ";
//lead[0]  = "d   d   e p   p g   p e     z   ";
//lead[1]  = "d     z   B   A     P G   P E D ";
//var padd = "d p a p d p a p d p a p d p a p ";
//var kick = "K   K   K   K   K   K   K   K   ";
//var snar = "    S       S       S       S S ";
//var hiha = "H HHH HHH HHH HHH HHH HHH HHH HH";

//var kick = "Kkkk kkkKkkk kkkKkkk kkkKkkk kkk";
//var snar = "    S    S  S SS    S   SS  S SS";

bass	= "A A A A F F F F C C C C G G G G ";
//bass	= "A A A A F F F F G G G G C C C C ";
lead[0]	= "c G F G f   f d d       G   H   ";
lead[1]	= "E A B e B A E F E     FED   C   ";
kick	= "  K   K   KK  K   K   K   KK  K ";
snar	= "S   S   S   S   S   S   S   S   ";
padd	= "                                ";
hiha	= "H H H H H H H H H H H H H H H H ";

var b = 0;		// beat
var i = 0;		// element in beat
var cb = 0;		// current general beat in song
var music_last;
var musicdelay = 16.67*6;
...
const sprite_iloveyou			= spr("iloveyou.png",			0.6);

const rndc = [ "adele_ny3.png", "C_dg.png", "C_daddy.png", "C_dogert.png", "omalley.png", "C_harass.png", "mrs_superconductor2.png", "polish_cow2.png", "epper2.png" ];
...
var sprite_fayah			= [ spr("fire1_.png"), spr("fire1_.png"), spr("fire1_.png") ];
var fayah_timer				= [ 0, 0, 0 ];
var sprite_efayah			= spr("fire1e.png");
var shot_timer = 0;
var efayah_timer = 0;
var eshot_timer = 0;
...
var sprite_harassplane1			= spr("airplane.png",			8);		sprite_harassplane1.oname = "One of HÃ¥rass' many airplanes";
...
var sprite_worker			= spr("airplane.png");
...
for (let t = 0; t < 5; t++) sprite_license_kocar[t] = spr("car_dg.png", 0.75);
var sprite_license_5_motcar		= spr("car_dg.png",			1.5);

var sprite_magnetdrown_seal		= spr("sealy.png");
var sprite_magnetdrown_magnet = new Array();
for (let t = 0; t < 6; t++) sprite_magnetdrown_magnet[t] = spr("magnet.png");
...
var sprite_talk_stork			= spr("stork.png");			sprite_talk_stork.oname = "Waldemar Aversione";
...
var sprite_talk_zanzibae		= spr("zanzibae.png");			sprite_talk_zanzibae.oname = "DJ Zanzibae";
...
var sprite_talk_moose			= spr("moose.png");			sprite_talk_moose.oname = "Moster Savage";
...
var sprite_talk_aff			= spr("aff.png");			sprite_talk_aff.oname = "Aff";
...
var sprite_talk_magnetguard4		= spr("magnetguard.png");		sprite_talk_magnetguard4.oname = "Ricardó Córdoba";
...
var sprite_talk_9 = spr("a_big_stone_with_muscles-removebg-preview.png");	sprite_talk_9.oname = "Rauserwelt Stonehenge";
var sprite_talk_10 = spr("magnetguard.png");					sprite_talk_10.oname = "Big Ridah";
var sprite_talk_11 = spr("magnetguard.png");					sprite_talk_11.oname = "Dickh";
var sprite_talk_12 = spr("sheepie-removebg-preview.png");			sprite_talk_12.oname = "Baba Black (too controversial for the group)";
var sprite_talk_13 = spr("an_eel_seen_from_the_front-removebg-preview.png");	sprite_talk_13.oname = "Johnny Racer";
var sprite_talk_14 = spr("magnetguard.png");					sprite_talk_14.oname = "Mary Cogarnagh";
var sprite_talk_15 = spr("magnetguard.png");					sprite_talk_15.oname = "Francesco";
var sprite_talk_16 = spr("magnetguard.png");					sprite_talk_16.oname = "Jamal";
var sprite_talk_17 = spr("magnetguard.png");					sprite_talk_17.oname = "Monique";
var sprite_talk_18 = spr("magnetguard.png");					sprite_talk_18.oname = "Eric Laithwaite";
var sprite_talk_19 = spr("magnetguard.png");					sprite_talk_19.oname = "Theodora Riverdale";
var sprite_talk_20 = spr("magnetguard.png");					sprite_talk_20.oname = "Bamse Patreon";
var sprite_talk_21 = spr("magnetguard.png");
var sprite_talk_22 = spr("magnetguard.png");
var sprite_talk_23 = spr("magnetguard.png");
var sprite_talk_24 = spr("a_fat_bear_with_a_polish_shirt-removebg-preview.png"); sprite_talk_24.oname = "Yuri";
//var sprite_talk_25 = spr("lenstravelier-zziTPieyuBI-unsplash-removebg-preview.png"); sprite_talk_25.oname = "Dixon Milano";
...
var sprite_talk_38 = spr("a_beaver_in_a_suit-removebg-preview.png");		sprite_talk_38.oname = "Council of Beavers - Councilor #12 - \"AÃ©nedor\"";
var sprite_talk_39 = spr("a_beaver_in_a_suit-removebg-preview.png");		sprite_talk_39.oname = "Council of Beavers - Councilor #13 - \"TinglÃn\"";
...
var sprite_talk_42 = spr("a_beaver_in_a_suit-removebg-preview.png");            sprite_talk_42.oname = "Council of Beavers - Councilor #16 - \"Nichólas\"";
...
var sprite_talk_71 = spr("magnetguard.png");					sprite_talk_71.oname = "Roger Smith";
...
var sprite_talk_79 = spr("a_hyena-removebg-preview.png");			sprite_talk_79.oname = "Bob Lesterson";
var sprite_talk_80 = spr("a_wise_wolf-removebg-preview.png");			sprite_talk_80.oname = "The Guardian of Life";
var sprite_talk_81 = spr("magnetguard.png");
var sprite_talk_82 = spr("an_octopus_with_giant_biceps-removebg-preview.png");	sprite_talk_82.oname = "Annabelle Tinglyn";
var sprite_talk_83 = spr("magnetguard.png");
var sprite_talk_84 = spr("a_lemur_with_glasses_and_a_suit-removebg-preview.png"); sprite_talk_84.oname = "Morten Ollon";
var sprite_talk_85 = spr("magnetguard.png");
...
var sprite_talk_92 = spr("originalharass.png");					sprite_talk_92.oname = "HÃ¥rass";
var sprite_talk_93 = spr("magnetguard.png");
...
var sprite_talk_96 = spr("magnetguard.png");
...
var sprite_talk_102 = spr("a_happy_santa_claus-removebg-preview.png");		sprite_talk_102.oname = "Nisse Rudolfsson";
...
var sprite_talk_108 = spr("C_harass.png");					sprite_talk_108.oname = "HÃ¥rass";
var sprite_talk_109 = spr("C_harass.png");					sprite_talk_109.oname = "HÃ¥rass";
...
var sprite_talk_114 = spr("puppy.png");						sprite_talk_114.oname = "Mrs Superconductor's Nr. 1 Hater";
var sprite_talk_115 = spr("20230923_130038-removebg-preview.png");		sprite_talk_115.oname = "Stefano DiPripedo's mom";
...
var sprite_talk_121 = spr("magnetguard.png");
var sprite_talk_122 = spr("magnetguard.png");
var sprite_talk_123 = spr("magnetguard.png");
var sprite_talk_124 = spr("magnetguard.png");
var sprite_talk_125 = spr("magnetguard.png");
var sprite_talk_126 = spr("wizzy.png");						sprite_talk_126.oname = "Wizzy";
var sprite_talk_127 = spr("a_little_dark_wizard_man_that_is_kinda_cute_1_-removebg-preview.png"); sprite_talk_127.oname = "Wobby";
...
var sprite_talk_132 = spr("an_eager_eagle_holding_a_microphone-removebg-preview.png"); sprite_talk_132.oname = "Janet Spice";
//var sprite_talk_133 = spr("an_eager_eagle_holding_a_microphone-removebg-preview.png"); sprite_talk_133.oname = "Janet Spice";
var sprite_talk_134 = spr("an_eager_eagle_holding_a_microphone-removebg-preview.png"); sprite_talk_134.oname = "Janet Spice";
...
var sprite_talk_138 = spr("magnetguard.png");					sprite_talk_138.oname = "Geoff Pesos";
var sprite_talk_139 = spr("magnetguard.png");
var sprite_talk_140 = spr("phone.png");
var sprite_talk_141 = spr("magnetguard.png");
var sprite_talk_142 = spr("phone.png");

var sprite_talk_144 = spr("magnetguard.png");
var sprite_talk_145 = spr("phone.png");
var sprite_talk_146 = spr("magnetguard.png");
var sprite_talk_147 = spr("magnetguard.png");
var sprite_talk_148 = spr("magnetguard.png");
var sprite_talk_149 = spr("magnetguard.png");
var sprite_talk_150 = spr("phone.png");
var sprite_talk_151 = spr("magnetguard.png");
...
var sprite_talk_155 = spr("phone.png");
...
var sprite_talk_167 = spr("a_wise_wolf-removebg-preview.png");			sprite_talk_167.oname = "The Guardian of Life";
var sprite_talk_168 = spr("magnetguard.png");
...
var sprite_talk_172 = spr("magnetguard.png");
var sprite_talk_173 = spr("magnetguard.png");
var sprite_talk_174 = spr("magnetguard.png");
var sprite_talk_175 = spr("mysterious_glowing_cube_with_strange_markings_etch-removebg-preview.png");
var sprite_talk_176 = spr("magnetguard.png");
...
var sprite_talk_183 = spr("beaverlog.png");					sprite_talk_183.oname = "Michael Quiggly";
var sprite_talk_184 = spr("diogoalves.png");					sprite_talk_184.oname = "Roger Fuckpissshit";
var sprite_talk_185 = spr("magnetguard.png");					sprite_talk_185.oname = "Portsmouth Reykjadottir";
...
var sprite_talk_187 = spr("magnetguard.png");					sprite_talk_187.oname = "Orar PÃ¥kem";
...
var sprite_talk_191 = spr("magnetguard.png");					sprite_talk_191.oname = "Denise Abscess";
var sprite_talk_192 = spr("magnetguard.png");					sprite_talk_192.oname = "Angela Karbunkel";
var sprite_talk_193 = spr("magnetguard.png");
var sprite_talk_194 = spr("magnetguard.png");
...
sprite[CAR_ADELE]			= spr("adele_ny3.png",	 		0.75);
sprite[CAR_DARK_GANDALF]		= spr("C_dg.png",			1);
sprite[CAR_DADDY]			= spr("C_daddy.png");
sprite[CAR_DOGERT]			= spr("C_dogert.png",			1);
sprite[CAR_OMALLEY]			= spr("omalley.png",			0.7);
sprite[CAR_HARASS]			= spr("C_harass.png",			0.5);
sprite[CAR_DISONESTY]			= spr("");
sprite[CAR_MRS_SUPERCONDUCTOR]		= spr("mrs_superconductor2.png",	0.9);
sprite[CAR_POLISH_COW]			= spr("polish_cow2.png");
sprite[CAR_EPPER]			= spr("epper2.png");

const sprite_pil = new Array();
sprite_pil[CAR_ADELE]			= spr("adele_ny3_pil.png", 		3, 0.75);
sprite_pil[CAR_DARK_GANDALF]		= spr("C_dg_pil.png",			4, 1);
...
sprite_pil[CAR_HARASS]			= spr("C_harass.png",			2, 0.5);
sprite_pil[CAR_DISONESTY]		= spr("");
sprite_pil[CAR_MRS_SUPERCONDUCTOR]	= spr("mrs_superconductor2_pil.png",	3.6, 0.9);
sprite_pil[CAR_POLISH_COW]		= spr("polish_cow2_pil.png",		4, 1);
sprite_pil[CAR_EPPER]			= spr("epper2_pil.png",			4, 1);

// miner
const sprite_adele_surprised		= spr("adele_ny3_e1.png",		0.75);
const sprite_adele_silent		= spr("adele_silent_.png",		0.75);
const sprite_adele_laughing		= spr("adele_silent____.png",		0.75);
const sprite_adele_nice			= spr("adele_silent______.png",		0.75);
const sprite_dg_right			= spr("C_dg__.png",			1);
const sprite_dg_sad			= spr("C_dg_________.png",		1);
const sprite_dg_communism		= spr("C_dg______.png",			1);
const sprite_daddy_confused		= spr("C_daddy_.png");
const sprite_daddy_happy		= spr("C_daddy___.png");
const sprite_daddy_blue			= spr("C_daddy____.png");
const sprite_daddy_anime		= spr("C_daddy_______.png");
const sprite_omalley_blue		= spr("omalley_.png",			0.7);
const sprite_omalley_yellow		= spr("omalley____.png",		0.7);
const sprite_omalley_pink		= spr("omalley______.png",		0.7);
const sprite_omalley_italy		= spr("omalley_________.png",		0.7);

const sprite_bak = new Array();
sprite_bak[CAR_ADELE]			= spr("C_adele_bak.png",		0.75);
sprite_bak[CAR_DARK_GANDALF]		= spr("C_dg_bak.png",			1);
sprite_bak[CAR_DADDY]			= spr("C_daddy_bak.png");
sprite_bak[CAR_DOGERT]			= spr("C_dogert_bak.png",		1);
sprite_bak[CAR_OMALLEY]			= spr("omalley.png",			0.7);
sprite_bak[CAR_HARASS]			= spr("C_harass_bak.png",		0.5);
sprite_bak[CAR_DISONESTY]		= spr("");
sprite_bak[CAR_MRS_SUPERCONDUCTOR]	= spr("mrs_superconductor2.png",	0.9);
sprite_bak[CAR_HARASS]			= spr("C_harass_bak.png");
sprite_bak[CAR_POLISH_COW]		= spr("polish_cow2_bak.png");
...
cz[CAR_HARASS]				= spr("car_harass_3.png",		0.75);
cz[CAR_DISONESTY]			= spr("",				0.75);
cz[CAR_MRS_SUPERCONDUCTOR]		= spr("car_mrs_superconductor.png",	0.75);
cz[CAR_POLISH_COW]			= spr("polish_bicycle.png",		0.75);	//car_polish_cow.png",		0.75);
...
const sound_error			= snd("");//error.mp3",			1,	false);
...
const sound_poof			= snd("poof.mp3",			0.6,	false);
const sound_click			= snd("ui_click.mp3",			1,	false);
const sound_pause			= snd("ui_pause.mp3",			1,	false);
const sound_explosion2			= snd("softer explosion.mp3",		0.4,	false);
const sound_cartoon			= snd("cartoon.mp3",			1,	false);
const sound_laser			= snd("laser.mp3",			0.6,	false);
const sound_ring			= snd("ring.mp3",			1,	false);
const sound_punch			= snd("sound_punch.mp3",		0.6,	false);
const sound_washingmachine		= snd("washingmachine.mp3",		0.8);
const sound_washingmachine2		= snd("washingmachine.mp3",		0.8);
const sound_washclick			= snd("washclick.mp3",			1,	false);
const sound_manlygrunt			= snd("manlygrunt.mp3",			1,	false);
const sound_treadmill			= snd("treadmill.mp3",			1,	false);
...
const sound_boing			= snd("boing.mp3",			1,	false);
const sound_chainsaw			= snd("chainsaw.mp3",			0.9,	false);
const sound_gun				= snd("gun.mp3",			1,	false);
const sound_gunshot			= snd("gunshot.mp3",			1,	false);
