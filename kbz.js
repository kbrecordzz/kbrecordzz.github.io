...
function main()
{
	...
	if (window.innerHeight > window.innerWidth)
	{
		...
		document.getElementById("snowboard").style = 
			"visibility: visible; position: absolute; top: 51%; left: 50vw+50vh; transform: translateX(80%); font-size: 2.4vh; line-height: 3.3vh; padding-left: 1%; padding-right: 1%; background-color: rgb(0,0,0,0.2);";
	...
	else
	{
		...
		document.getElementById("notacarclub").style = 
			"visibility: visible; position: absolute; top: 58%; left: 50%; transform: translateX(-50%); font-size: 2.4vh; line-height: 3.3vh; padding-top: 1vh; padding-left: 1.5vh; padding-right: 1.5vh; background-color: rgb(115,32,93,0.75);";
		document.getElementById("notacarclub_description").style.fontSize = "2vh";
		
		document.getElementById("snowboard").style = 
			"visibility: visible; position: absolute; top: 75%; left: 50%; transform: translateX(60%); font-size: 2.4vh; line-height: 3.3vh; padding-top: 1vh; padding-left: 1.5vh; padding-right: 1.5vh; background-color: rgb(115,32,93,0.75);";
		document.getElementById("snowboard_description").style.fontSize = "2vh";
