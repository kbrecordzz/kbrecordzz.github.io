...
const freeroam_washing_2_name		= "HÃ¥rass teaches you how to be a man";
...
const freeroam_gasstation_name		= "Did someone say HÃ¥rass The Gasstation Clerk?";
...
function dialog_set_metadata(at_object)
{
	...
	else if (at_object === sprite[5])		{ if (sound_harass.paused === true)	{ sound_harass.play(); }	head = "C_harass_head.png";		name = "HÃ¥rass"; }
...
// race - man måste gå tillbaka till cut:en innan och inte fortsätta på efter-racet:s standard-story!!
	...
	else if (cut % MODULUS_FREEROAM_OR_RACE === 0 && cut % MODULUS_FREEROAM_ONLY !== 0)
	{
		...
		else if (race_state === RACE_DURING)
		{
			...
			else if (cut === CUT_RACE_DGTRAVEL)
			{
				...
				if (distance_get_xz(player.position.x,player.position.z, 1348,1997) < 30) bet_pers(sprite[0], "You see all the dead trees here? They died when HÃ¥rass peed here one time.");
			}
			else if (cut === CUT_RACE_HAFTLAN)
			{
			...
			else if (cz_leader == 5) document.getElementById("leader").innerHTML = "(" + (player_lap-1) + " laps left)<br>#1. <img width=30% src=\"files/C_harass_head.png\"></img>HÃ¥rass";
		...
		else if (race_state === RACE_AFTER)
		{
			...
			if (cut === CUT_RACE_1)
			{
				if (iwillbeback === true) ts_end_from_talk(last_cut_before_race);	// detta kommer inte funka om man är innan ett annat race och klickar sig in på detta race (men bör vara lugnt för man kan ändå inte trycka på dem)
				else
				{
...
//!!
// efter freeroam_washing_2 (göra en massa saker med hÃ¥rass),
// så ropar dark gandalf att ni ska race:a. alla åker till startpunkten
// men där står en worker, som man då ska klicka på för att prata med.
// efter det är EPISODE 1 slut
//
...
break; case 2.50:bet_pers(sprite[2],"Wouldn't it have more fuel if it didnâ€™t fart it out all the time?");
...
break; case 4.75:bet_pers(sprite[3],"SOON.WE.WONâ€™T.NEED.JACKETS.ANYMORE. PROBLEM.SOLVED.");
...
break; case 1007419:cc(sprite[9],"now iâ€™m closing my eyes. when i open them i want to see cash in my hand.");
...
break; case 1011506:cc(sprite[8],"Yes it's me, Polish Cow. And I am, indeed, a cow from Poland. czeÅ›Ä‡ wam idioci!");
...
break; case 1011824:cc(sprite[5],"Hi, I'm the one and only HÃ¥rass! Nice to meet you. also fuck you!!");
...
break; case 1011829:cc(sprite[1],"Hey guys, can you tell HÃ¥rass to stop it?");
...
break; case 1011837:cc(sprite[4],"Okay, so welcome to the car club I guess, HÃ¥rass! I also recently joined!");
...
// CUT_FREEROAM_WASHING - är FPS! hÃ¥rass är på fel plats! bestäm vad som ska ske här!! kanske först inne hos hÃ¥rass, sen ska han plötsligt lära dig att bli en man
break; case 1001200:
if (r_click_on === 1) { if (distance_get(player, r_click_obj) < r_click_dist) { sprite_ui_mouseclick.visible = true; if (mouseclick === true) { ts_end(r_click_cut); } } }
ts_start();
ts_during();
...
break; case 1001211:cc(sprite[5],"Uh, if it did, why does this site say â€œVODDLERâ€ in all caps at the top?");
break; case 1001212:cc(shelf,"let me see your computer...");
break; case 1001213:cc(shelf,"yes, as I thought, you havenâ€™t deleted your cache the last ten years. Of course you will see old stuff then!");
...
// gör om detta till cutscene när man ställer sig på startlinjen!!
// CUT_RACE_HAFTLAN
break; case 1011950:
ts_start();
ts_during();
...
break; case 6.25:bet_pers(sprite[1],"Okay, let's start. HÃ¥rass gets some handicap, because he's the only senior of us.");
...
// denna ska spelas upp innan man kör racet!!
// SLUT PÅ EPISODE 1
...
break; case 1012505:cc(sprite[3],"THE.SAME.GOES.FOR.ADELE.DADDY.HÃ…RASS.AND.O'MALLEY.I.LOVE.YALL.SO.YOU.ARE.FREE.TO.DO.WHATEVER.YOU.WANT.");
...
//TIME: 2
break; case 3.25:bet_pers(shelf,"Is that HÃ¥rass over there?");
...
break; case 1029205:cc2(sprite[0],"Throw eggs at HÃ¥rass' moms house?", " I have a plan! Let's throw eggs at HÃ¥rass' moms house!");
...
break; case 1030509:cc2(sprite[5],"HÃ¥RASS!!! ", " LET US IN FOR CRAP'S SAKE!!!");
break; case 1030510:cc(sprite[7],"that's not the password, sorry.");
break; case 1030511:ccS("guess we'll have to figure it out ourselves. ", " HÃ¥rass, have some elegance.");
...
//dorime dorime, bävern stiger upp lite mot himlen igen.
...
break; case 1053017:cc(sprite_talk_27," Ljudet dånade. Färger som aldrig funnits förut uppenbarade sig.");
break; case 1053018:cc(sprite_tak_27," Men det totala kaoset skänkte en onekbar känsla av lugn och tillfredsställelse, och till slut lade sig också allt skakande, dånande och flimrande.");
...
break; case 1053408:cc(sprite[5],"*ritar en massa illegala formler och ekvationer, och en bild på adele när han äter potatis*");
break; case 1053409:cc(sprite[5],"*sprutar eld på tavlan*");
break; case 1053410:cc(sprite[5],"*skallar tavlan igen så den vänder sig till andra sidan*");
break; case 1053411:cc(sprite[5],"*ritar en fotorealistisk karta över Houston's skyline*");
break; case 1053412:cc(sprite[5],"*tar fram en fiskmås ur sin bakficka för att illustrera saker*");
...
break; case 1053415:cc(sprite[5],"*spelar munspel och smäller en bäver i ansiktet med en stock*");
...
break; case 1031104:cc(sprite[7],"*montage över deras gamla romans*");
break; case 1031105:cc(sprite[7],"De möttes i kriget (fioler i bakgrunden), sitter bredvid varandra i en skyttegrav");
break; case 1031106:cc(sprite[7],"flyger ett stridsplan och släpper en bomb ihop och kysser varandra medan den demolerar en stad");
break; case 1031107:cc(sprite[7],"Klipp till att de langar varandra olika brickor inne i skolmatsalen");
break; case 1031108:cc(sprite[7],"Klipp till när de är forskningskollegor och fifflar med provrör, de sätter på varandra safety-glasögon");
...
break; case 1031111:cc(sprite[7],"stoppar upp djur tillsammans på naturhistoriska museet");
break; case 1031112:cc(sprite[7],"upptäcker magnetismen ihop");
break; case 1031113:cc(sprite[7],"är på 16-årsfest, mrs s får hålla upp p cows hår när han spyr");
break; case 1031114:cc(sprite[7],"flyttar landmassor från marianergraven (som då var marianer-normal botten) och skapar ön JAPAN");
break; case 1031115:cc(sprite[7],"Klipp att de ligger bredvid varandra i sängen, godnatt");
...
break; case 2000113:cc(sprite[5],"HÃ¥rass found a new gang to harass and continued to completely and unapologetically be himself in all situations.");
...
break; case 2000615:cc(sprite[5],"HÃ¥rass continued to completely and unapologetically be himself in all situations.");
...
break; case 9000002:cc(sprite[5],"me too but iâ€™m gonna do the other order like shit then piss etc");
...
break; case 9000007:cc(sprite[1],"donâ€™t say anything!!");
break; case 9000008:cc(sprite[5],"iâ€™m not sure if i can promise to not say anything. They are so small. In a so so funny way. Everybody must know.");
break; case 9000009:cc(sprite[1],"okay, thenâ€¦ then Iâ€™ll tell them about Adeles mom.");
break; case 9000010:cc(sprite[5],"NO you canâ€™t tell them about how I just BAM BAM BAM made sweet love to Mama Adele, that would be the worst. I would have to start doing the same to everybodyâ€™s moms if they found out about what a wonderful and tender night I gave her.");
...
break; case 9000016:cc(sprite[5],"iâ€™ll give you 100 bucks too if you keep quiet about my bedroom magic.");
break; case 9000017:cc(sprite[1],"then you get 100 bucks from me too.");
break; case 9000018:cc(sprite[5],"Great, then weâ€™re double safe.");
...
break; case 9000301:cc(sprite[1],"jag byggde en ny civilisation lite snabbt. Kolla nu, så här kan man köra runt i den! *kör runt i sin nya civilisation*");
break; case 9000302:cc(sprite[0],"okej coolt men var är brudarna?");
break; case 9000303:cc(sprite[1],"adele vill du skriva lagboken? Jag tänker vi ska ha typ sju lagar");
break; case 9000304:cc(sprite[1],"och hÃ¥rass du kan va polis och shelf du kan vara invånare och sen...");
break; case 9000305:cc(sprite[1],"det här kändes bra i mitt huvud igår kväll men nu börjar jag tveka lite på idén");
break; case 9000306:cc(sprite[2],"vad gör det till en civilisation? Räcker det med att det är något som... finns?");
break; case 9000307:cc(sprite[1],"levande människor, hus, kommunism.");
break; case 9000308:cc(sprite[0],"finns väl civissatiiner utan kommunimism? Vi har inte det i vår värld");
break; case 9000309:cc(sprite[2],"det dark gandalf sa fast minus kommunism");
break; case 9000310:cc(sprite[1],"nej o vad är det för civilisation att snacka om?!");
break; case 9000311:cc(sprite[0],"vad är en civisation?");
break; case 9000312:cc(sprite[5],"stad typ!");
break; case 9000313:cc(sprite[0],"säg det då");
break; case 9000314:cc(sprite[1],"stad med kommunism");
break; case 9000315:cc(sprite[2],"fortfarande nej...");
break; case 9000316:cc(sprite[0],"kommunimism... varför är ord så långa, jag glömmer alltid början när jag kommer till slutet");
break; case 9000317:cc(sprite[5],"exakt. ord är alldeles för långa: Kommunism, civilisation, socialism, solidaritet,");
break; case 9000318:cc(sprite[1],"mhm!! så ska det låta!! *njuter*");
break; case 9000319:cc(sprite[5],", kapitalism, entreprenör,");
break; case 9000320:cc(sprite[1],"nej men vad säger du, sluta säga såna fula ord!");
break; case 9000321:cc(sprite[5],"jag menar att långa ord är svåra att förstå, och att det är mycket bättre med korta ord, exempelvis: pee, poo, shit, cunt, ass,");
break; case 9000322:cc(sprite[1],"nu börjar det likna nåt igen");
break; case 9000323:cc(sprite[2],"Tack för dagens möte. Vi kom återigen inte fram till något.");
...
else if (g>=0.8&&g<0.9)	cc(sprite[5],		"I wanna grow a beard. But Iâ€™m not a loser, sooo maybe that will stop my plans");
else if (g>=0.9&&g<1)	cc(sprite[5],		"Fuck you!!");
break; case 5000002:    	ts_end_from_talk(last_cut_before_talk);
//  5000051
break; case 5000051:cc(sprite_harassplane1," Yes, HÃ¥rass got a bunch of airplanes in his backyard.");
...
break; case 5000054:cc(sprite_harassplane1," That's HÃ¥rass, I guess!");
break; case 5000055: 	ts_end_from_talk(last_cut_before_talk);
//  5000101
break; case 5000101:
g = pseudorandom(player.position.x+player.position.z);
if (g>=0&&g<0.1)	cc(sprite_talk_stork,		"Jag ska bara \"pegga upp\" och Ã¶va i nÃ¥gra timmar!");
else if (g>=0.1&&g<0.2)	cc(sprite_talk_stork,		"Kan du akta dig? Jag ska prova en ny sorts sving frÃ¥n kina.");
else if (g>=0.2&&g<0.3)	cc(sprite_talk_stork,		"Ooh! NÃ¤ra green! Riktigt jÃ¤vla golf va.");
else if (g>=0.3&&g<0.4)	cc(sprite_talk_stork,		"Ã„r jag i vÃ¤gen? Ja men du fÃ¥r vÃ¤l planera din golfrunda lite bÃ¤ttre! Jag stannar ALLTID hÃ¤r och blockerar.");
else if (g>=0.4&&g<0.5)	cc(sprite_talk_stork,		"Ska du golfa i de klÃ¤derna?");
else if (g>=0.5&&g<0.6)	cc(sprite_talk_stork,		"HÃ¤r Ã¤r det jÃ¤rnsjua som gÃ¤ller! Eller... kanske jÃ¤rnnia. Eller Ã¥tta. Hmm, fÃ¥r tÃ¤nka lite till innan jag slÃ¥r...");
else if (g>=0.6&&g<0.7)	cc(sprite_talk_stork,		"Vill du ocksÃ¥ spela? Ska bara slÃ¥ mitt slag fÃ¶rst. *stretchar i 10 min fÃ¶rst)");
else if (g>=0.7&&g<0.8)	cc(sprite_talk_stork,		"Det handlar inte mest om vilka klubbor du har, eller om hur du slÃ¥r, utan om vilket energidrycksfÃ¶retag som sponsrar dig.");
else if (g>=0.8&&g<0.9)	cc(sprite_talk_stork,		"Jag har lagt smÃ¥ markeringar dÃ¤r jag har landat med bollen fÃ¶rut. Det Ã¤r dÃ¤rfÃ¶r banan Ã¤r full med smÃ¥ plastmatlÃ¥delock som gÃ¶r det svÃ¥rt att spela.");
else if (g>=0.9&&g<1)	cc(sprite_talk_stork,		"Kan du hÃ¥lla min mobil som har en webblÃ¤sarflik med sÃ¶kresultat pÃ¥ en massa konstig furry-fanfiction uppe, medan jag svingar ett tag?");
...
//  5002001
break; case 5002001:cc(sprite_talk_harassdad," Hey, I'm HÃ¥rass dad, HÃ¥rass! Nice to meet ya!");
break; case 5002002:cc(sprite_talk_harassdad," HÃ¥rass can be a pain in the ass sometimes... But that comes from his environment only and NOT from his genes!");
...
break; case 5009202:cc(sprite_talk_70," Except if your name is HÃ¥rass. Then there is a fixed limit.");
...
break; case 5009253:cc(sprite_talk_70," To answer your question. Yes, the water shortage is caused by HÃ¥rass' washing machines.");
...
// han maste se acklig ut! det är hÃ¥rass, mission completed.
...
break; case 5013001:cc(sprite_talk_108," I'm HÃ¥rass!!");
...
break; case 5013101:cc(sprite_talk_109," HÃ¥rass!!");
break; case 5013102:cc(sprite_talk_109," HÃ¥RASS HÃ¥RASS HÃ¥RASS HÃ¥RASS!!");
...
break; case 5013702:cc(sprite_talk_115," this one is especially good. it's sewage water from the beautiful district of ÃŽle Saint-Louis in Paris! 5 stars!");
...
break; case 5014301:cc(sprite_talk_121," You smell like HÃ¥rass. Can you move 15 meters that way, please?");
break; case 5014302:  ts_end_from_talk(last_cut_before_talk);
//when
break; case 5014351:cc(sprite_talk_121," HÃ¥rass is really EXACTLY the same in person as his public image.");
...
break; case 5016106:cc(sprite[5],"Name... it says: HÃ¥- Never mind. What were you saying, O'Malley?");
...
break; case 5016614:cc(shelf,"uh. Cheers. *shelf lÃ¤mnar*");
...
//sprite_talk_146:
break; case 5016801:cc(sprite[5],"HÃ¥rass... HÃ¥rass... HÃ¥rass... HÃ¥rass *throws out different hÃ¥rasses from his closet*");
break; case 5016802:cc(sprite[5],"which HÃ¥rass should i be today?");
...
//sprite_talk_156: 
break; case 5017801:cc(sprite[5],"HÃ¥rass' diary #8273");
...
//sprite_talk_157: 
break; case 5017901:cc(sprite[5],"HÃ¥rass' diary #1362");
...
//sprite_talk_158: 
break; case 5018001:cc(sprite[5],"HÃ¥rass' diary #912");
...
//sprite_talk_159: 
break; case 5018101:cc(sprite[5],"HÃ¥rass' diary #913");
...
//sprite_talk_160:
break; case 5018201:cc(sprite[5],"HÃ¥rass' diary #1182");
...
//sprite_talk_161: 
break; case 5018301:cc(sprite[5],"HÃ¥rass' diary #3");
...
//sprite_talk_162: 
break; case 5018401:cc(sprite[5],"HÃ¥rass' diary #2418");
...
break; case 5024803:cc(sprite[0],"do i know you? *nervös*");
...
break; case 5024813:cc(shelf,"*två vidriga alternativ*");
